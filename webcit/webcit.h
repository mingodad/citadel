...
#define CLIENT_ID		4
#define CLIENT_VERSION		752		/* This version of WebCit */
#define MINIMUM_CIT_VERSION	752		/* min required Citadel ver */
#define	LIBCITADEL_MIN		752		/* min required libcitadel ver */
